...
{
    var t = new Tree();
    /* using simple method to directly load tree from internal text without passing it via a div
     * modification by @JML
     * */
    if(element_id.indexOf('(') != -1)
    {
      var newick = element_id;
    }
    else
    {
  ...
  //					// idea from http://srufaculty.sru.edu/david.dailey/svg/getCTM.svg
	...
	//					
	//					var colour = 'lightgray'; //category20c[index];
	//					
